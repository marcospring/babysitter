...
public interface BaseDao {
	...
	<T> T getSingleResultByHQL(Class<T> clazz, String hql, Object... param) throws RuntimeException;

	<T> T getSingleResultByHQLObjectParams(Class<T> clazz, String hql, Object[] param) throws RuntimeException;

	<T> List<T> getListResultByHQL(Class<T> clazz, String hql, Object... param) throws RuntimeException;

	<T> List<T> getListResultByHQLObjectParams(Class<T> clazz, String hql, Object[] param) throws RuntimeException;

	<T> List<T> getListResultByHQL(Class<T> clazz, String hql) throws RuntimeException;

	<T> Pagination<T> getPageResult(Class<T> clazz, String hql, int pageNo, int pageSize, Object... param) throws RuntimeException;
