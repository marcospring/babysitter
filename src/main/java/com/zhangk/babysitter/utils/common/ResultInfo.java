...
public enum ResultInfo {
	...
	INF_EMPTY(1000, "信息不全"), CHECK_CODE_ERROR(1001, "验证码错误"), BAD_REQUEST(500, "系统错误"), BABYSITTER_NULL(1002, "月嫂不存在"), BABYSITTER_ORDER_NULL(1003, "月嫂订单不存在"), VALID_USER_PASS(
			...
			1009, "日期格式化错误"), PROMOTION_NULL(1010, "活动信息不存在"), EXIST_USER(1011, "用户已存在"), NOTICE_NULL(1012, "通知不存在"), FILE_NULL(1013, "上传文件为空"), USER_NULL(1014, "用户已存在"), COUNTYLEVEL_NOT_NULL(
			1015, "级别已经存在"), BABYSITTER_NOT_NULL(1016, "月嫂已存在"), SUCCESS(0, "操作成功");
