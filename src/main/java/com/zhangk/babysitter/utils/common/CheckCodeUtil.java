...
public class CheckCodeUtil {
	...
	public static void sendMessage(String phoneNo, String... arg) {
		...
		// *******************************************************************************
		restAPI.init(Constants.CODE_DOMAIN, Constants.CODE_PORT);
		...
		// *******************************************************************************
		restAPI.setAccount(Constants.CODE_ACCOUNT, Constants.CODE_AUTH);
		...
		// *******************************************************************************
		restAPI.setAppId(Constants.CODE_APPID);
