...
public class Pagination<T> {
	...
	// }
	//
	// private void buildPageList(StringBuilder pageStrBuilder, int frount, int
	// endMinus) {
	// if (getPageNo() < frount) {
	...
	// } else if (getPageNo() >= frount && getPageNo() < getPageCount() -
	// endMinus) {
	// for (int i = 1; i < 3; i++) {
	// buildPage(pageStrBuilder, i);
	// }
	...
	// pageStrBuilder.append("<li><a href=\"").append(getRequestUri()).append("?pageNo=").append(getPageNo()
	// + 1 > getPageCount() ? getPageCount() : getPageNo() + 1)
	...
	// pageStrBuilder.append("<li><a href=\"").append(getRequestUri()).append("?pageNo=").append(getPageNo()
	// - 1 <= 0 ? 1 : getPageNo() - 1).append("&pageSize=")
