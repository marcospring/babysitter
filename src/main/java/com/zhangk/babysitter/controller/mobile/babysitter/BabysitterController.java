...
public class BabysitterController extends BaseController {
	...
	public PageResult updateBankCard(String guid, String bankName, String bankCardNo, String bankUserName) {
		if (StringUtils.isEmpty(bankName) || StringUtils.isEmpty(bankCardNo) || StringUtils.isEmpty(bankUserName)) {
			return getErrRes(ResultInfo.INF_EMPTY);
		}
		res = babysitterService.updateBankCard(guid, bankName, bankCardNo, bankUserName, getResult());
		return res;
	}
