...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/manage/credential/babysitterList.html',
							fit : true,
							fitColumns : false,
							border : false,
							pagination : true,
	...
	function addOrder(id) {
		...
		parent.$
				.modalDialog({
					...
					width : 1000,
					height : 550,
					href : '${pageContext.request.contextPath}/manage/credential/goAdd.html?id='
							+ id                             
				});
	}
...
<div id="toolbar" style="display: none;">
		<a onclick="addOrder();" href="javascript:void(0);"
			...
			data-options="plain:true,iconCls:'pencil_add'">查看证件</a>
