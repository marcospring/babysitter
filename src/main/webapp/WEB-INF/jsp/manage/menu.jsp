...
<script type="text/javascript">
	...
	var layout_west_tree_url = '${pageContext.request.contextPath}/manage/user/userMenu.html';
	$(function() {
...
<div class="easyui-accordion" data-options="fit:true,border:false">
	<div title="菜单列表" style="padding: 5px;" data-options="border:false,isonCls:'anchor',tools : [ {
