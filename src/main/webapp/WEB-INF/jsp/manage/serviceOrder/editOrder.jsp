...
<script type="text/javascript">
	$(function() {
		...
		var url = '${pageContext.request.contextPath}/manage/serviceOrder/edit.html' ;
		$('#form').form({
			url : url,
			onSubmit : function() {
		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed" style="font-size:14px;">
				<tr>
					...
					<td style="text-align:left;">${vo.employer.username }</td>
                    </tr>
				<tr>
				<td style="text-align:right;">雇主电话</td>
                    <td style="text-align:left;">${vo.employer.mobilePhone }</td>
				</tr>
				<tr>
					<td style="text-align:right;">雇主地址</td>
					<td style="text-align:left;"><input name="employerAddress" type="text" placeholder="请输入雇主地址" class="easyui-validatebox span2" data-options="required:true" value="${vo.address }"></td>
                  </tr>
                   <tr>
