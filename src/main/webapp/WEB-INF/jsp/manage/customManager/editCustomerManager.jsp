...
<script type="text/javascript">
	$(function() {
		...
		var url = '${pageContext.request.contextPath}/manage/customerManager/edit.html' ;
		$('#form').form({
			url : url,
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed"
				...
				<tr>
					<td style="text-align: right;">客户经理密码</td>
					<td style="text-align: left;"><input name="password" type="text"
						placeholder="请输入密码" class="easyui-validatebox span2"
						data-options="required:true" value="${vo.password }"></td>
				</tr>
				<tr>
					<td style="text-align: right;">客户经理姓名</td>
					<td style="text-align: left;"><input name="name"
						type="text" placeholder="请输入姓名" class="easyui-validatebox span2"
				...
				<tr>
					...
					<td style="text-align: left;"><input name="telephone"
						type="text" placeholder="请输入电话" class="easyui-validatebox span2"
